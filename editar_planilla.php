<?php
	...
	{
		$id_factura=intval($_GET['id_planilla']);
		$campos="clientes.id_cliente, clientes.nombre_cliente, clientes.telefono_cliente, clientes.dni_cliente, facturas.id_vendedor, facturas.fecha_factura, facturas.condiciones, facturas.estado_factura, facturas.numero_factura";
		...
		if ($count==1)
		{
				...
				$dni_cliente=$rw_factura['dni_cliente'];
				...
				<div class="form-group row">
				  ...
				  <label for="tel1" class="col-md-1 control-label">Teléfono</label>
					...
					<label for="dni" class="col-md-1 control-label">Dni</label>
							<div class="col-md-3">
								<input type="text" class="form-control input-sm" id="dni" placeholder="Dni" readonly value="<?php echo $dni_cliente;?>">
							</div>
				 </div>
						<div class="form-group row">
