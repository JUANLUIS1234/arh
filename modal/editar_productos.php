		  ...
		  <div class="modal-body">
			...
			<div id="resultados_ajax2"></div>
			  <div class="form-group">
				<label for="mod_dni" class="col-sm-3 control-label">Documento</label>
				<div class="col-sm-8">
				  <input type="text" class="form-control" id="mod_dni" name="mod_dni" placeholder="Código del producto" required>
					<input type="hidden" name="mod_dni" id="mod_dni">
				</div>
			  </div>
			   <div class="form-group">
